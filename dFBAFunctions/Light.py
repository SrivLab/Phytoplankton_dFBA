class TotSolEng:
    ...
    # Function that will call all other calculation sub-functions.
    ...
    def waterabs(self,depth,speckey='pure'):
        import math
        import numpy as np
        ...
        # If (Pope; Weidemann; Fry, 2000) get back, sea water will go here. 
    ...
    def sshas(self):
        ...
        elif (self.declin >= 0 and latitude > 0) or (self.declin < 0 and latitude < 0):
            self.ssha = 180
        else:
            self.ssha = 0
    ...
    def tsts(self):
        ...
        # bind the fixed true solar within a single day -720<x<720 minutes.
